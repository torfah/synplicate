...
train_df = pd.read_csv("hypothyroid.csv")
...
median_income = tf.feature_column.numeric_column("age")
feature_columns.append(median_income)

# Represent population as a floating-point value.
population = tf.feature_column.numeric_column("TSH")
...
epochs = train_model(my_model, train_df, epochs, 
...
soft_model.predict({'age':np.array([114]),'TSH':np.array([34.0])})
