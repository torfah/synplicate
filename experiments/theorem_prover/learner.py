...
train_df = pd.read_csv("theorem_prover.csv")
...
age = tf.feature_column.numeric_column("F1")
feature_columns.append(age)

monthly_income = tf.feature_column.numeric_column("F10")
...
soft_model.predict({'F1':np.array([20]),'F10':np.array([2000])})
