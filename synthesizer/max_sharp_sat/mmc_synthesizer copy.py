...
os.system("./bc2cnf -all synthesizer/encoding.sat encoding_temp.dimacs")

dimacs_file = open("encoding.dimacs","w")
dimacs_file.write("c max")
maxvars = encoder.extract_max_variables("synthesizer/max_sharp_sat/encoding_temp.dimacs")
for s in maxvars:
